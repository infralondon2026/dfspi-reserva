...
const uiBase = {
  es: {
    ...
    heroBody:
      "Perfumería, bebidas, tecnología y delicatessen de las mejores marcas, con precios libres de impuestos, en Puerto Iguazú.",
    heroOffers: "Ver destacados",
    ...
    categoriesBody:
      "Perfumería, bebidas, delicatessen y tecnología con precios libres de impuestos.",
    ...
    offersBody:
      "Consultá en tienda las promociones vigentes y sus condiciones.",
    ...
    mapBody:
      "Explorá el plano de la tienda y descubrí qué marcas vas a encontrar en cada área.",
    ...
    howBody:
      "Sin filas, sin pago anticipado y con la tranquilidad de encontrar lo que elegiste.",
    step1: "Elegí",
    ...
    visitorBody:
      "Revisá los requisitos de acceso y las condiciones aduaneras de tu país de destino.",
    visitorAccessTitle: "Acceso y documentación",
    visitorAccessBody:
      "Para ingresar al predio debés registrar tu salida ante la aduana del país de procedencia y presentar la documentación migratoria requerida.",
    visitorCustomsTitle: "Compras y franquicias",
    visitorCustomsBody:
      "La tienda no fija límites mientras no se presuma fin comercial. Las franquicias y límites de ingreso dependen del país de destino.",
    visitorTransportTitle: "Cómo llegar",
    visitorTransportBody:
      "Estamos en el Paso de Frontera, Ruta Nacional 12, km 1645,5. No contamos con traslados propios; consultá servicios de transporte local.",
    ...
    ctaBody:
      "Descubrí todo lo que tenemos para vos en Puerto Iguazú, camino a las Cataratas.",
    ctaButton: "Ver catálogo",
    inStoreOnly: "Información y disponibilidad en tienda",

    // Catalog
    catalogKicker: "CATÁLOGO INFORMATIVO",
    catalogTitle: "Conocé nuestros productos.",
    catalogBody:
      "Explorá categorías, marcas y presentaciones disponibles en Duty Free Shop Puerto Iguazú.",
    catalogNotice:
      "Este catálogo es informativo. No permite compras ni reservas online; los precios y la disponibilidad se confirman directamente en la tienda.",
    ...
    productInfoNote:
      "La disponibilidad, la presentación y el precio se confirman directamente en la tienda.",
    consultProduct: "Consultar producto",
    callStore: "Llamar a la tienda",
    directions: "Cómo llegar",
    productEmailSubject: "Consulta de producto",
    ...
    emptyCartBody:
      "Sumá productos y los guardaremos hasta la fecha que elijas.",
    ...
    terms:
      "Acepto las condiciones de reserva, privacidad y requisitos aduaneros.",
    ...
    chatTopics: "Ver todos los temas",
    ask: "Escribí tu consulta...",
    send: "Enviar",
    fallback:
      "No encontré una respuesta exacta. Escribinos a info@dfspi.com o llamanos al 03757 421050.",
    ...
    // Footer & misc
    footerBody:
      "Marcas internacionales, servicios para tu visita y una experiencia única en la frontera.",
    store: "Tienda",
    help: "Ayuda",
    ...
    promoDisclaimer:
      "Promociones sujetas a los términos y condiciones de cada entidad. Consultá la vigencia en tienda.",

    // Novedades
    newsKicker: "NOVEDADES",
    newsTitle: "Lo último de la tienda",
    newsBody:
      "Enterate de lanzamientos, eventos y novedades antes de tu visita.",
    ...
    newsletterBody:
      "Recibí promociones, lanzamientos y noticias de la tienda en tu email.",
    ...
    newsletterPrivacy:
      "Usamos tu email solo para enviarte novedades. Podés darte de baja cuando quieras.",
  ...
  pt: {
    ...
    heroBody:
      "Perfumaria, bebidas, tecnologia e delicatessen das melhores marcas, com preços livres de impostos, em Puerto Iguazú.",
    heroOffers: "Ver destaques",
    explore: "Explorar catálogo",
    how: "Como funciona",
    ...
    categoriesBody:
      "Perfumaria, bebidas, delicatessen e tecnologia com preços livres de impostos.",
    ...
    featuredBody:
      "Produtos escolhidos para surpreender, presentear e aproveitar.",
    viewAll: "Ver tudo",
    ...
    mapBody:
      "Explore a planta da loja e descubra quais marcas você vai encontrar em cada área.",
    ...
    howBody:
      "Sem filas, sem pagamento antecipado e com a tranquilidade de encontrar o que você escolheu.",
    step1: "Escolha",
    ...
    visitorBody:
      "Confira os requisitos de acesso e as condições aduaneiras do seu país de destino.",
    visitorAccessTitle: "Acesso e documentação",
    visitorAccessBody:
      "Para entrar no estabelecimento, registre sua saída na aduana do país de origem e apresente a documentação migratória exigida.",
    visitorCustomsTitle: "Compras e franquias",
    visitorCustomsBody:
      "A loja não estabelece limites desde que não haja finalidade comercial. As franquias e limites dependem do país de destino.",
    visitorTransportTitle: "Como chegar",
    visitorTransportBody:
      "Estamos na passagem de fronteira, Ruta Nacional 12, km 1645,5. Não oferecemos transporte próprio; consulte serviços locais.",
    ...
    ctaBody:
      "Descubra tudo o que temos para você em Puerto Iguazú, a caminho das Cataratas.",
    ctaButton: "Ver catálogo",
    inStoreOnly: "Informações e disponibilidade na loja",

    // Catalog
    catalogKicker: "CATÁLOGO INFORMATIVO",
    catalogTitle: "Conheça nossos produtos.",
    catalogBody:
      "Explore categorias, marcas e apresentações disponíveis no Duty Free Shop Puerto Iguazú.",
    catalogNotice:
      "Este catálogo é informativo. Não permite compras nem reservas online; os preços e a disponibilidade são confirmados diretamente na loja.",
    ...
    productInfoNote:
      "A disponibilidade, a apresentação e o preço são confirmados diretamente na loja.",
    consultProduct: "Consultar produto",
    callStore: "Ligar para a loja",
    directions: "Como chegar",
    productEmailSubject: "Consulta de produto",
    ...
    terms:
      "Aceito as condições de reserva, privacidade e requisitos aduaneiros.",
    ...
    chatTopics: "Ver todos os temas",
    ask: "Digite sua pergunta...",
    send: "Enviar",
    fallback:
      "Não encontrei uma resposta exata. Escreva para info@dfspi.com ou ligue 03757 421050.",
    ...
    // Footer & misc
    footerBody:
      "Marcas internacionais, serviços para sua visita e uma experiência única na fronteira.",
    store: "Loja",
    help: "Ajuda",
    company: "London Supply Group",
    ...
    promoDisclaimer:
      "Promoções sujeitas aos termos e condições de cada entidade. Consulte a validade na loja.",

    // Novidades
    newsKicker: "NOVIDADES",
    newsTitle: "As últimas da loja",
    newsBody:
      "Fique por dentro de lançamentos, eventos e novidades antes da sua visita.",

    // Serviços
    servicesKicker: "NOSSOS SERVIÇOS",
    servicesTitle: "Pensado para a sua experiência",
    servicesBody:
      "Tudo o que oferecemos para tornar sua visita mais confortável.",

    // Newsletter
    newsletterKicker: "NEWSLETTER",
    newsletterTitle: "Receba nossas novidades",
    newsletterBody:
      "Receba promoções, lançamentos e notícias da loja no seu email.",
    ...
    newsletterPrivacy:
      "Usamos seu email apenas para enviar novidades. Você pode cancelar quando quiser.",
...
const en: UiDictionary = {
  ...
  heroBody:
    "Fragrances, beverages, technology and delicatessen from leading international brands in Puerto Iguazú.",
  heroOffers: "View highlights",
  ...
  categoriesBody:
    "Fragrances, beverages, delicatessen and technology from international brands.",
  ...
  offersBody:
    "Visit the store to learn about current promotions and their terms.",
  ...
  mapBody:
    "Browse the store map and discover the brands available in each area.",
  ...
  visitorBody:
    "Review access requirements and the customs rules of your destination country.",
  visitorAccessTitle: "Access and documents",
  visitorAccessBody:
    "To enter the premises, register your departure with the customs authority of your country of origin and carry the required migration documents.",
  visitorCustomsTitle: "Purchases and allowances",
  visitorCustomsBody:
    "The store does not impose limits unless a commercial purpose is presumed. Customs allowances and entry limits depend on the destination country.",
  visitorTransportTitle: "Getting here",
  visitorTransportBody:
    "We are at the border crossing on National Route 12, km 1645.5. We do not operate transportation; please contact a local service.",
  ...
  ctaBody:
    "Discover everything waiting for you in Puerto Iguazú, on the way to the Falls.",
  ctaButton: "View catalog",
  inStoreOnly: "Product information and availability in store",
  catalogKicker: "INFORMATIONAL CATALOG",
  catalogTitle: "Discover our products.",
  catalogBody:
    "Explore categories, brands and product options available at Duty Free Shop Puerto Iguazú.",
  catalogNotice:
    "This catalog is for information only. Online purchases and reservations are not available; prices and availability are confirmed directly at the store.",
  ...
  pickupDays: "Pickup within 7 days",
  productInfoNote:
    "Availability, presentation and price are confirmed directly at the store.",
  consultProduct: "Ask about this product",
  callStore: "Call the store",
  directions: "Get directions",
  productEmailSubject: "Product inquiry",
  loading: "Loading...",
  ...
  chatTopics: "View all topics",
  ask: "Type your question...",
  send: "Send",
  fallback:
    "I could not find an exact answer. Email info@dfspi.com or call +54 3757 421050.",
  ...
  footerBody:
    "International brands, visitor services and a unique experience at the border.",
  store: "Store",
  help: "Help",
  ...
  promoDisclaimer:
    "Promotions are subject to their specific terms and conditions. Check validity in store.",
  newsKicker: "NEWS",
  ...
  newsletterPrivacy:
    "We only use your email to send store news. You may unsubscribe at any time.",
