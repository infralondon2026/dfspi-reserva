...
const uiBase = {
  es: {
    ...
    catalogBody: 'Explorá categorías, marcas y presentaciones disponibles en Duty Free Shop Puerto Iguazú.',
    catalogNotice: 'Este catálogo es informativo. No permite compras ni reservas online; los precios y la disponibilidad se confirman directamente en la tienda.',
  ...
  pt: {
    ...
    catalogBody: 'Explore categorias, marcas e apresentações disponíveis no Duty Free Shop Puerto Iguazú.',
    catalogNotice: 'Este catálogo é informativo. Não permite compras nem reservas online; os preços e a disponibilidade são confirmados diretamente na loja.',
...
const en: UiDictionary = {
  ...
  catalogBody: 'Explore categories, brands and product options available at Duty Free Shop Puerto Iguazú.',
  catalogNotice: 'This catalog is for information only. Online purchases and reservations are not available; prices and availability are confirmed directly at the store.',
