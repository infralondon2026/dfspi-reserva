...
export interface Reservation { code:string; customer:{name:string;email:string;phone:string}; pickupDate:string; expiresAt:string; createdAt:string; status:ReservationStatus; items:CartItem[]; locale:Locale; total:number }
